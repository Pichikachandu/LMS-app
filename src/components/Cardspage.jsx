...
function Cardspage() {
  ...
  return (
    ...
    '>
           ...
           <button className='absolute right-[9%] bottom-2 px-5 py-2.5 border-2 border-black bg-black text-white hover:bg-gray-800 rounded-lg text-lg font-medium flex flex-row items-center justify-center gap-2 transition-colors duration-200 whitespace-nowrap' onClick={()=>navigate("/allcourses")}>
  View all Courses
